...
fig1_MASS1 = plot(h, x1(1),y1(1),'ko','MarkerSize',pendulum1_params('m1')*2,...
    'MarkerFaceColor','k');
fig1_MASS2 = plot(h, x2(1),y2(1),'ko','MarkerSize',pendulum1_params('m2')*2,...
    'MarkerFaceColor','k');
fig1_L1 = plot(h, [0 x1(1)],[0 y1(1)],'k-');
fig1_L2 = plot(h, [x1(1) x2(1)],...
    [y1(1) y2(1)],'k-');

fig1_MASS1_2 = plot(h, x1_2(1),y1_2(1),'ro','MarkerSize',pendulum1_params('m1')*2,...
    'MarkerFaceColor','r');
fig1_MASS2_2 = plot(h, x2_2(1),y2_2(1),'ro','MarkerSize',pendulum1_params('m2')*2,...
    'MarkerFaceColor','r');
fig1_L1_2 = plot(h, [0 x1_2(1)],[0 y1_2(1)],'r-');
fig1_L2_2 = plot(h, [x1_2(1) x2_2(1)],...
    [y1_2(1) y2_2(1)],'r-');

fig1_MASS1_3 = plot(h, x1_3(1),y1_3(1),'bo','MarkerSize',pendulum1_params('m1')*2,...
    'MarkerFaceColor','b');
fig1_MASS2_3 = plot(h, x2_3(1),y2_3(1),'bo','MarkerSize',pendulum1_params('m2')*2,...
    'MarkerFaceColor','b');
